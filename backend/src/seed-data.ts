/**
 * Seed content transcribed from the Figma design. Images are intentionally
 * left empty and uploaded later via the admin panel.
 *
 * Section yang belum ada isinya di Figma diseed dengan `group_name` saja
 * (items kosong) supaya judul section-nya sudah siap di admin panel.
 */

// Kartu overview di home + submenu navbar. `category_key` menentukan
// halaman kategori mana yang dibuka saat kartu diklik.
